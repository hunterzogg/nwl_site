...
script, per Hunter's explicit request each time. Season-long and weekly props are still just
designed/described in the flier, not yet entered as real questions in the database.
